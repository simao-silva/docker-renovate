...
ARG RENOVATE_VERSION=35.3.0

# Base image
#============
FROM simaofsilva/containerbase-buildpack:6.4.0@sha256:cb1ab0582f5ac8a306e5b2030503d43b94da887393f4f82d5fdcd3b343876fe0 AS base
