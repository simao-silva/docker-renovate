...
ARG RENOVATE_VERSION=35.119.2

# Base image
#============
FROM simaofsilva/containerbase-buildpack:8.0.4@sha256:c27992f8b9d50f0e20e7f095eac65857ec62f26d987729f016cf44eed72c0fdb AS base
