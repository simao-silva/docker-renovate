...
ARG RENOVATE_VERSION=32.63.1

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:a516cbd4ed0a6a0ebe62d876bd875c55d0cbaf388514ef9eb59d99e00ca86953 AS base
...
RUN install-tool docker v20.10.16
