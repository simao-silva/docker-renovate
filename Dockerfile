...
ARG RENOVATE_VERSION=35.57.3

# Base image
#============
FROM simaofsilva/containerbase-buildpack:7.8.4@sha256:77ce95b0e90844b29044ad486079e0ffc93450a1eec54453a9c7e79473d44275 AS base
