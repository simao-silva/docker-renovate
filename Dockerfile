...
ARG RENOVATE_VERSION=32.42.1

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:6881c68b17b68b6cc8bcdecf90e553ef4077432e7ce3d7f4497619d0282eeae1 AS base
