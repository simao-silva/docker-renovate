...
ARG RENOVATE_VERSION=32.140.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:9eb77cdd71d40a365eb631731fac04261211673a8e4440726f1dc25a12b95c32 AS base
