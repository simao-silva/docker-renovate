...
ARG RENOVATE_VERSION=32.52.3

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:1ddf82deb616ab78490cfc8b9203be7fde7e896ea3efcafaed1d6972bcaf2287 AS base
