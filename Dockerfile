...
ARG RENOVATE_VERSION=34.119.4

# Base image
#============
FROM simaofsilva/containerbase-buildpack:6.0.7@sha256:88f6206e59325239f0982e1f9cd3a1f4cd229a885420ded856380909688b3802 AS base
