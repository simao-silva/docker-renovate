...
ARG RENOVATE_VERSION=32.4.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:d5d31db7ecc69565bfa0c4d1a918d254898fef72fcef5dc39f929333b6b9275e AS base
...
RUN install-tool docker v20.10.13
