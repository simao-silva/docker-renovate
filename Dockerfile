...
ARG RENOVATE_VERSION=32.154.8

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:a69698fb22baae09a496cb6e8f0427502ef5b938e0066c76ddb425bd7297faa8 AS base
