...
ARG RENOVATE_VERSION=32.26.2

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:7fd1f0cd72f576d4c5c3753dc0fafbe7a539125e3da256a644ea3349f303a184 AS base
