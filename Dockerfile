...
ARG RENOVATE_VERSION=32.11.5

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:f427e97f9b3d1aeb1548d6bd7b7ffa651f0c445823b987eed7b4a90761cd441a AS base
