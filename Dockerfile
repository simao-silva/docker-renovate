...
ARG RENOVATE_VERSION=32.153.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:2e05a4ab8f4f6bd4e7c31b337c3f6c08134598e8da857afaee9d992433ad0185 AS base
