...
ARG RENOVATE_VERSION=32.161.1

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:f996e4048ff553735c6def1a16d34255cfcf0da23a534a8ee79a8beab356d092 AS base
