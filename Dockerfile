...
ARG RENOVATE_VERSION=31.97.2

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:60cdbbb2d9b494862a5869d9284f5e4e0d5fb3235691fd7e4cf13cdb5b068425 AS base
