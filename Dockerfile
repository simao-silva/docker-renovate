...
ARG RENOVATE_VERSION=32.40.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:2d1128a95e7d2d34408df0a3824ef769a212b3adaec31aec807188ca92a292d2 AS base
