...
ARG RENOVATE_VERSION=32.241.4

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:062f1aa624816fe94899bbf680b363d7822160d33f99c1d0a142890c588be11a AS base
...
RUN install-tool docker v20.10.20
