...
ARG RENOVATE_VERSION=32.6.6

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:3f143fd510b3658c88c31a1d8603268f1a0d652eb7605d5b8137272fa432dfc8 AS base
