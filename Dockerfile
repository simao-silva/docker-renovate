...
ARG RENOVATE_VERSION=35.24.4

# Base image
#============
FROM simaofsilva/containerbase-buildpack:7.2.1@sha256:9129bb249f51d51f35bf08135000bfeb3170a6692626bea92ec2604d9e181f62 AS base
