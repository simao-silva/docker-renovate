...
ARG RENOVATE_VERSION=32.22.1

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:c42129a36a451c5ca052b5680eba19d74b7405508b5887e5fb7b5682886cc4b8 AS base
