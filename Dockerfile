...
ARG RENOVATE_VERSION=32.75.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:017eaafe202f795473d8160bdef800e2af469d56b55da9c534bb454f37365674 AS base
