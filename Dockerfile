...
ARG RENOVATE_VERSION=35.51.0

# Base image
#============
FROM simaofsilva/containerbase-buildpack:7.8.3@sha256:6f3e9cad12c301679b8d90770a9ba8fd5ef695aa7e0bb637e732d528cf4481f0 AS base
...
RUN install-tool docker v23.0.4
