...
ARG RENOVATE_VERSION=32.180.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:c65d1f40413ea67f92dc289dc219f2d00974a37a9b81c42bcb987186064e74fc AS base
