...
ARG RENOVATE_VERSION=32.190.5

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:b33ca3bbfdf14264602eef5399ffd53dd1698ec85e2ab3679cf9b0d7cafd6941 AS base
