...
ARG RENOVATE_VERSION=32.154.4

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:9ac165235bb63787e4a47a6c3f01bfe4bee081209e8d9bf3fab555988982b786 AS base
