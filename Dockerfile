...
ARG RENOVATE_VERSION=32.0.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:781e47e6f405495b3d72824d4b024aeb42be8902488ad2f9b83f2fa64bf68382 AS base
