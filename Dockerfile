...
ARG RENOVATE_VERSION=32.66.8

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:97c153df3c07f5c3dafe51d77e1a2cab94ed2e692cb621c3bc53ec3c29c87f06 AS base
