...
ARG RENOVATE_VERSION=35.73.1

# Base image
#============
FROM simaofsilva/containerbase-buildpack:7.9.0@sha256:e8ed55e3c09855da7057c2d949a7f2034d1819cbec7408a03efc638d70a3ea00 AS base
...
RUN install-tool docker v23.0.5
