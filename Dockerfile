...
ARG RENOVATE_VERSION=34.88.0

# Base image
#============
FROM simaofsilva/containerbase-buildpack:5.10.2@sha256:a948206c5cb9a11da263f967403606cf5d01aa11cab3212ba212d73d5cb5e82d AS base
