...
ARG RENOVATE_VERSION=32.212.0

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:fbeea2ff1d8a453aa86ab7d52bfc68eca2ab759e7b41a5ea6454a5e1f27b0b63 AS base
