...
ARG RENOVATE_VERSION=31.89.3

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:809fc7b7d3f42c9df828effaf323111d0f72687a3d247fa04c646d8028bccc27 AS base
