...
ARG RENOVATE_VERSION=32.76.2

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:469d71ce9e6d511376bd80c4f0f5aab814ad960222b11985f405489cb5b7539d AS base
