...
ARG RENOVATE_VERSION=32.45.3

# Base image
#============
FROM simaofsilva/renovatebot-docker-buildpack:latest@sha256:b1a044e7a4a9b1bea6db050870b4d8323cf27777bb78713c364b662500fb7c7d AS base
...
RUN install-tool docker v20.10.15
